...
### Next step
Optional follow-ups recorded in MAINNET_READINESS.md (passkey PRF second factor, a real contract wallet in the suites, funded invitations out of scope). No open gate.
