...
- Measured: R_op prove 521 ms (10 threads) / 1.8 s (1 thread) native, 6.5 s wasm; verify 0.94 ms; batch of 32 at 0.79 ms per op (sqlite-bound). See `docs/peal-links/BENCHMARKS.md`.
