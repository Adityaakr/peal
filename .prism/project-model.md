...
- Branch `feat/peal-links`. Spec `docs/peal-links/SPEC.md`; living log `docs/peal-links/BUILD_STATUS.md` (gates A to E passed, F in progress); decisions `docs/peal-links/decisions/0001..0009`.
...
- Trust model of the local demo: real proofs, single-node ledger, local setup, committee-attested bridge with a single-process signer fixture; consensus not started (blocker). Everything labelled in `GET /links/v1/status`.
